...
CHECKPOINT_FILE="${CHECKPOINT_FILE:-${OUTPUT_DIR}/deploy_tls.checkpoints}"
...
step_prepare_tls_client() {
  "${SCRIPT_DIR}/prepare_tls_benchmark_client.sh"
}

step_bootstrap_tls_brokers() {
  "${SCRIPT_DIR}/bootstrap_tls_brokers.sh"
}
...
run_step "prepare_tls_client" step_prepare_tls_client
run_step "bootstrap_tls_brokers" step_bootstrap_tls_brokers

log "TLS cluster deployment flow completed."
