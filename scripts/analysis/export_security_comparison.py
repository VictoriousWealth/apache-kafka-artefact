...
def write_plots(output_dir: Path, matches: list[dict[str, Any]]) -> list[Path]:
    ...
    plot_specs = [
        ...
        ("interval_avg_latency_p95_overhead_pct.svg", "Interval Average Latency p95 Change vs Plaintext", "interval_avg_latency_ms_p95"),
        ("interval_avg_latency_p99_overhead_pct.svg", "Interval Average Latency p99 Change vs Plaintext", "interval_avg_latency_ms_p99"),
        ...
        ("client_network_tx_overhead_pct.svg", "Benchmark Client Network TX Change vs Plaintext", "benchmark_client_network_tx_bytes_delta"),
        ("broker_network_rx_overhead_pct.svg", "Broker Network RX Change vs Plaintext", "broker_network_rx_bytes_delta_total"),
        ("broker_disk_write_overhead_pct.svg", "Broker Disk Write Change vs Plaintext", "broker_disk_write_sectors_delta_total"),
    ]
    generated: list[Path] = []
